...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post = new Post(null, sdf.parse("21/03/2028"), "Partiu viagem", "Vou viajar para São paulo. Abroçoes!",
				new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("23/03/2028"), "Bom dia", "Acordeu feliz hoje!", new AuthorDTO(maria));
